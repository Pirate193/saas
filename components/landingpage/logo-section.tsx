            ...
            <InfiniteSlider speedOnHover={20} speed={40} gap={112}>
              ...
              <div className="flex">
                <img
                  ...
                  src="/logos/University_of_Michigan_wordmark.svg"
              ...
              <div className="flex">
                <img
                  className="mx-auto h-4 w-fit dark:invert"
                  src="/logos/university-of-bristol-1.svg"
              ...
              <div className="flex">
                <img
                  className="mx-auto h-5 w-fit dark:invert"
                  src="/logos/Yale_University_logo.svg"
              ...
              <div className="flex">
                <img
                  className="mx-auto h-5 w-fit dark:invert"
                  src="/logos/stanford-cardinals.svg"
                  alt="Stanford Cardinals Logo"
                  height="20"
                  width="auto"
                />
              </div>
