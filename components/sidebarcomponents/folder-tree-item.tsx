...
interface FolderTreeItemProps {
  ...
  getFolderItemCounts: (folderId: Id<"folders"> | string) => {
    notes: number;
    subfolders: number;
...
export function FolderTreeItem({
  ...
  const fetchNotesInFolder = useQuery(api.notes.fetchNotesInFolder, {
    folderId: folder._id,
  });
  const fectchFilesInFolder = useQuery(api.files.fetchfiles, {
    folderId: folder._id,
  });
